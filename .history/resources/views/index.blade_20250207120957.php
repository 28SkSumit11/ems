@include('layouts.header')
    <table id="example" class="display d-none" style="width:100%">
        <thead>
            <tr>
                <th>Name</th>
                <th>Position</th>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 row">
                <select class="col-md-2 form-select" id="entries_per_page" aria-label="Default select example">
                    <option value="10" selected>10</option>
                    <option value="25">25</option>
                    <option value="50">50</option>
                    <option value="100">100</option>
                </select>
                <p class="col-md-8">entries per page.</p>
            </div>
            <div class="col-md-6">
