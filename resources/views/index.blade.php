            ...
            <div class="col-md-6 justify-content-end">
                <div class="row">
                    ...
                    <div class="col-md-8 position-relative">
                        ...
                        <div id="customDateInputs" class="shadow p-3 mb-5 bg-body-tertiary rounded" style="display: none;">
                            <div class="d-flex justify-content-end row">
                                ...
                                <button id="applyCustomRange" class="btn btn-primary mt-3 w-50">Apply</button>
                            </div>
                        </div>                      
                    </div>
                </div>
